...
interface RealityConfrontationProps {
  onStepComplete: (data: string) => void;
  initialData?: string;
}

const RealityConfrontationForm = ({
  onStepComplete,
  initialData,
}: RealityConfrontationProps) => {
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            >
              ¿Cómo te desafía esta situación y qué es lo que realmente está
              sucediendo?
            </label>
            <Textarea
              id="situation"
              ...
              placeholder="Cuéntanos sobre tu desafio..."
...
export default RealityConfrontationForm;
